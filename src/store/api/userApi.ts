...
export interface NotificationSettings {
  orderTrackingEmailsEnabled: boolean;
}
...
export const userApi = baseSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    // Get All Designers
    getAllDesigners: builder.query<Designer[], void>({
      query: () => "/user/designers",
      providesTags: ["User"],
    }),
    ...
    // Get designer assigned order items
    getDesignerOrderItems: builder.query<DesignerOrderItem[], number>({
      query: (designerId) => `/user/designers/${designerId}/order-items`,
      providesTags: (result, error, designerId) => [
        { type: "User", id: `designer-items-${designerId}` },
      ],
    }),
    ...
    createManager: builder.mutation<any, StaffCreateRequest>({
      query: (data) => ({
        url: "/user/admin/create/manager",
        method: "POST",
        body: data,
      }),
      invalidatesTags: ["User"],
    ...
    createVendorUser: builder.mutation<any, StaffCreateRequest>({
      query: (data) => ({
        url: "/user/admin/create/vendor",
        method: "POST",
        body: data,
      }),
      invalidatesTags: ["User"],
    ...
    createDesignerUser: builder.mutation<any, StaffCreateRequest>({
      query: (data) => ({
        url: "/user/admin/create/designer",
        method: "POST",
        body: data,
      }),
      invalidatesTags: ["User"],
    ...
    getNotificationSettings: builder.query<NotificationSettings, void>({
      query: () => "/user/admin/notification-settings",
      providesTags: [{ type: "User", id: "notification-settings" }],
    }),

    updateNotificationSettings: builder.mutation<NotificationSettings, NotificationSettings>({
      query: (data) => ({
        url: "/user/admin/notification-settings",
        method: "PUT",
        body: data,
      }),
      invalidatesTags: [{ type: "User", id: "notification-settings" }],
    }),
